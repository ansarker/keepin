  ...
  return (
    <div className="bg-gray-900 min-h-screen flex items-center justify-center">
      <div className="w-full lg:w-1/3 md:w-1/2 md:rounded-lg md:bg-white p-6 md:p-12" style={{width: "480px"}}>
        ...
        <div className="mb-6">
          <h1 className="text-lg text-white md:text-gray-900 md:text-2xl md:mb-3 font-bold">Sign in</h1>
        </div>
        <div className="mb-6">
          <div className="mb-4">
            <label className="font-semibold hidden md:block text-base mb-2 text-white md:text-gray-700">Username or Email</label>
            <input onChange={(e) => setUsername(e.target.value)} type="text" placeholder="Username or Email" className="w-full px-3 py-2 rounded border outline-none text-gray-700" />
          </div>
          <div className="mb-4">
        ...
        <Link to="/forgotpassword" className="text-base font-normal md:font-bold text-white md:text-blue-800 hover:text-blue-400">
          Forgot Password?
        </Link>
        <div className="flex flex-row items-center justify-center mt-6">
          <span className="text-white md:text-gray-700 text-sm font-medium mr-3">Not a member?</span>
          <Link to="/signup" className="text-sm font-medium text-blue-700 hover:text-blue-500">Create account</Link>
        </div>
      </div>
    </div>
  );
