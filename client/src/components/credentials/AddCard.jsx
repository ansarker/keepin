...
const AddNew = ({ categories, setData, data, setShowModal }) => {
  ...
  const submitAccountInfo = () => {
    const add = () => {
      ...
      setError(undefined);
      axios
        .post(`${api}/passwords/create`, accountInfo)
        .then((response) => {
          setPending(false);
    ...
    <div>
      ...
      <div className="w-full px-6 pt-6">
        ...
        <select
          ...
          className="block w-full bg-gray-200 text-gray-700 capitalize focus:border-gray-700 rounded py-3 px-4 focus:outline-none"
        >
      ...
      <button
        ...
        className="w-full py-3 bg-gray-700 hover:bg-gray-700 text-white uppercase text-lg font-bold tracking-wider"
      >
